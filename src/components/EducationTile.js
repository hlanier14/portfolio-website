    ...
    return (
        <>
            <div 
                ...
                className={`bg-background-secondary dark:bg-background-dark-darker rounded-2xl p-6 border transition-all duration-200 cursor-pointer hover:shadow-xl hover:scale-[1.01] ${
                    isCurrent 
                        ? 'border-primary-main border-2 shadow-lg shadow-primary-main/20' 
